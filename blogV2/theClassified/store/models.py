...
class Product(models.Model):
    ...
    picture4 = CloudinaryField('picture4')
    picture5 = CloudinaryField('picture5')
    picture6 = CloudinaryField('picture6')
    picture7 = CloudinaryField('picture7')
...
class Store(models.Model):
    ...
    employees = models.ManyToManyField(settings.AUTH_USER_MODEL, null=True,related_name='store_employee')
