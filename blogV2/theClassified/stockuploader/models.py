...
class Nasdaq(models.Model):
    ...
    cik = models.IntegerField(default=None, blank=True, null=True)
    universe = models.CharField(max_length=200, null=True, blank=True, default=None)
...
class IncomeStatement(models.Model):
    ...
    cost_of_revenue = models.IntegerField(default=0, blank=True, null=True)
    gross_profit = models.IntegerField(null=True, blank=True, default=0)
    gross_profit_ratio = models.FloatField(max_length=400, null=True, blank=True, default=0.0)
    research_and_development_expenses = models.IntegerField(null=True, blank=True, default=0)
    general_and_administrative_expenses = models.IntegerField(null=True, blank=True, default=0)
    selling_and_marketing_expenses = models.IntegerField(null=True, blank=True, default=0)
    selling_general_and_admin_expenses = models.IntegerField(null=True, blank=True, default=0)
    other_expenses = models.IntegerField(null=True, blank=True, default=0)
    operating_expenses = models.IntegerField(null=True, blank=True, default=0)
    cost_and_expenses = models.IntegerField(null=True, blank=True, default=0)
    interest_income = models.IntegerField(null=True, blank=True, default=0)
    interest_expense = models.IntegerField(null=True, blank=True, default=0)
    depreciation_and_amortization = models.IntegerField(null=True, blank=True, default=0)
    ebitda = models.IntegerField(null=True, blank=True, default=0)
    ebitda_ratio = models.FloatField(max_length=400, null=True, blank=True, default=0.0)
    operating_income = models.IntegerField(null=True, blank=True, default=0)
    operating_income_ratio = models.FloatField(max_length=400, null=True, blank=True, default=0.0)
    total_other_income_expense = models.IntegerField(null=True, blank=True, default=0)
    income_before_tax = models.IntegerField(null=True, blank=True, default=0)
    income_before_tax_ratio = models.FloatField(max_length=400, null=True, blank=True, default=0.0)
    income_tax_expense = models.IntegerField(null=True, blank=True, default=0)
    net_income = models.IntegerField(null=True, blank=True, default=0)
    ...
    weighted_average_shs_out = models.IntegerField(null=True, blank=True, default=0)
    weighted_average_shs_out_dil = models.IntegerField(null=True, blank=True, default=0)
...
class CashFlowStatement(models.Model):
    ...
    depreciation_and_amortization = models.IntegerField(default=0, blank=True, null=True)
    deferred_income_tax = models.IntegerField(null=True, blank=True, default=0)
    stock_based_compensation = models.IntegerField(null=True, blank=True, default=0)
    change_in_working_capital = models.IntegerField(null=True, blank=True, default=0)
    accounts_receivables = models.IntegerField(null=True, blank=True, default=0)
    inventory = models.IntegerField(null=True, blank=True, default=0)
    accounts_payables = models.IntegerField(null=True, blank=True, default=0)
    other_working_capital = models.IntegerField(null=True, blank=True, default=0)
    other_non_cash_items = models.IntegerField(null=True, blank=True, default=0)
    net_cash_provided_by_operating_activities = models.IntegerField(null=True, blank=True, default=0)
    investments_in_property_plant_and_equipment = models.IntegerField(null=True, blank=True, default=0)
    acquisitions_net = models.IntegerField(null=True, blank=True, default=0)
    purchases_of_investments = models.IntegerField(null=True, blank=True, default=0)
    sales_maturities_of_investments = models.IntegerField(null=True, blank=True, default=0)
    other_investing_activites = models.IntegerField(null=True, blank=True, default=0)
    net_cash_used_for_investing_activites = models.IntegerField(null=True, blank=True, default=0)
    debt_repayment = models.IntegerField(null=True, blank=True, default=0)
    common_stock_issued = models.IntegerField(null=True, blank=True, default=0)
    common_stock_repurchased = models.IntegerField(null=True, blank=True, default=0)
    dividends_paid = models.IntegerField(null=True, blank=True, default=0)
    other_financing_activites = models.IntegerField(null=True, blank=True, default=0)
    net_cash_used_provided_by_financing_activities = models.IntegerField(null=True, blank=True, default=0)
    effect_of_forex_changes_on_cash = models.IntegerField(null=True, blank=True, default=0)
    net_change_in_cash = models.IntegerField(null=True, blank=True, default=0)
    cash_at_end_of_period = models.IntegerField(null=True, blank=True, default=0)
    cash_at_beginning_of_period = models.IntegerField(null=True, blank=True, default=0)
    operating_cash_flow = models.IntegerField(null=True, blank=True, default=0)
    capital_expenditure = models.IntegerField(null=True, blank=True, default=0)
    free_cash_flow = models.IntegerField(null=True, blank=True, default=0)
...
class BalanceSheet(models.Model):
    ...
    short_term_investments = models.IntegerField(default=0, blank=True, null=True)
    cash_and_short_term_investments = models.IntegerField(null=True, blank=True, default=0)
    net_receivables = models.IntegerField(null=True, blank=True, default=0)
    inventory = models.IntegerField(null=True, blank=True, default=0)
    other_current_assets = models.IntegerField(null=True, blank=True, default=0)
    total_current_assets = models.IntegerField(null=True, blank=True, default=0)
    property_plant_equipmentNet = models.IntegerField(null=True, blank=True, default=0)
    goodwill = models.IntegerField(null=True, blank=True, default=0)
    intangibleAssets = models.IntegerField(null=True, blank=True, default=0)
    long_term_investments = models.IntegerField(null=True, blank=True, default=0)
    tax_assets = models.IntegerField(null=True, blank=True, default=0)
    other_non_current_assets = models.IntegerField(null=True, blank=True, default=0)
    total_non_current_assets = models.IntegerField(null=True, blank=True, default=0)
    other_assets = models.IntegerField(null=True, blank=True, default=0)
    total_assets = models.IntegerField(null=True, blank=True, default=0)
    short_term_debt = models.IntegerField(null=True, blank=True, default=0)
    tax_payables = models.IntegerField(null=True, blank=True, default=0)
    deferred_revenue = models.IntegerField(null=True, blank=True, default=0)
    other_current_liabilities = models.IntegerField(null=True, blank=True, default=0)
    total_current_liabilities = models.IntegerField(null=True, blank=True, default=0)
    long_term_debt = models.IntegerField(null=True, blank=True, default=0)
    deferred_revenue_non_current = models.IntegerField(null=True, blank=True, default=0)
    other_non_current_liabilities = models.IntegerField(null=True, blank=True, default=0)
    total_non_current_liabilities = models.IntegerField(null=True, blank=True, default=0)
    other_liabilities = models.IntegerField(null=True, blank=True, default=0)
    capital_lease_obligations = models.IntegerField(null=True, blank=True, default=0)
    total_liabilities = models.IntegerField(null=True, blank=True, default=0)
    preferred_stock = models.IntegerField(null=True, blank=True, default=0)
    common_stock = models.IntegerField(null=True, blank=True, default=0)
    retained_earnings = models.IntegerField(null=True, blank=True, default=0)
    accumulated_other_comprehensive_income_loss = models.IntegerField(null=True, blank=True, default=0)
    other_total_stockholders_equity = models.IntegerField(null=True, blank=True, default=0)
    total_stockholders_equity = models.IntegerField(null=True, blank=True, default=0)
    total_liabilities_and_stockholders_equity = models.IntegerField(null=True, blank=True, default=0)
    minority_interest = models.IntegerField(null=True, blank=True, default=0)
    total_equity = models.IntegerField(null=True, blank=True, default=0)
    total_liabilities_and_total_equity = models.IntegerField(null=True, blank=True, default=0)
    total_investments = models.IntegerField(null=True, blank=True, default=0)
    total_debt = models.IntegerField(null=True, blank=True, default=0)
    net_debt = models.IntegerField(null=True, blank=True, default=0)
